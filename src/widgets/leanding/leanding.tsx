...
export function Leanding() {
  return (
    <div className="flex-auto leading-normal tracking-normal gradient w-full">
        ...
        <div className="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
          <div className="p-3 z-10">
            ...
            <h1 className="my-4 text-5xl font-bold " >
              База готовых решений для маркетологов, разработчиков и дизайнеров !
            </h1>
            <p className="leading-normal text-2xl mb-8">
              Получи доступ ко всем современным информационным AI интерфейсам!
            </p>
            <Link
              href="/en/log-in"
              type="button"
